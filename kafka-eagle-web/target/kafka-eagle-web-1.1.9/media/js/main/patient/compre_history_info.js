function changeUser() {
    ...
    var $timeline_content_source = $("#timeline_content-template").html();
    ...
    var timeline_content_template = Handlebars.compile($timeline_content_source);
    $.ajax({
        url:"/ke/patient_analysis/history/getAllUserEncounter?userId="+userId,
        type:'get',
        dataType:"json",
        success:function (data)  {
            data.forEach(function (t) {
                if(t.date) {
                    t.date = timestampToTime(t.date);
                }
            });
            var timeline_content_html = timeline_content_template(data);
            $('.timeline').empty();
            $(timeline_content_html).appendTo('.timeline');
...
function initPage() {
    ...
    $.ajax({
        url:"/ke/patient_analysis/history/getAllUserEncounter",
        type: "get",
        dataType: "json",
        success: function (data) {
            data.forEach(function (t) {
