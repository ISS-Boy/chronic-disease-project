                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="timelineshow">
                            ...
                            <c:forEach items="${encounterList}" var="enc" varStatus="status">
                                <c:if test="${status.index%2==0}">
                                <li>
                                    <div class="tl-circ"></div>
                                    <div class="timeline-panel">
                                        <div class="tl-heading">
                                            <h4 class="encounterName">${enc.encounter}</h4>
                                            <p><small class="text-muted encounterDate"><i class="glyphicon glyphicon-time"></i>  <fmt:formatDate value="${enc.date}" pattern="yyyy/MM/dd" />
                                                   </small></p>
                                        </div>
                                        <div class="tl-body">
                                            <p class="encounterDescription">${enc.description}</p>
                                            <%--<button class="btn" value="${encounter_id}"><a href="/ke/patient_analysis/history_detail" >查看详情</a></button>--%>
                                            <button class="btn btn-primary btn-sm eventDetail_btn"  data-toggle="modal" value="${enc.user_id}" onclick="handlerSelect('${enc.encounter}')" data-target="#myEncounterModal">
                                ...
                                <li class="timeline-inverted">
                                    ...
                                    <div class="timeline-panel">
                                        <div class="tl-heading">
                                            <h4 class="encounterName">${enc.encounter}</h4>
                                            <p><small class="text-muted encounterDate"><i class="glyphicon glyphicon-time"></i><fmt:formatDate value="${enc.date}" pattern="yyyy/MM/dd" /></small></p>
                                        </div>
                                        <div class="tl-body">
                                            <p class="encounterDescription">${enc.description}</p>
                                            <!--<a href="#" target="_blank">查看详情</a>-->
                                            <button class="btn btn-primary btn-sm eventDetail_btn" onclick="handlerSelect('${enc.encounter}')" data-toggle="modal" data-target="#myEncounterModal">
                                               查看详情
                                            </button>
                                        </div>
                                    </div>
...
<jsp:include page="../public/script.jsp">
    <jsp:param value="main/patient/history_info.js" name="loader" />
</jsp:include>
